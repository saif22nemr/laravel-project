...
?>
<?php echo $__env->yieldContent('phpCode'); ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="animsition">
    <div class="page-wrapper">
        <!-- HEADER MOBILE-->
        <?php if(!isset($noAside)): ?>
        <header class="header-mobile d-block d-lg-none">
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="<?php echo e(asset('images/icon/logo.png')); ?>" alt="CoolAdmin" />
                        </a>
        ...
        <!-- MENU SIDEBAR-->
        <?php if(!isset($noAside)): ?>
            <?php echo $__env->make('layout.template.aside', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
        <?php endif; ?>
        <!-- END MENU SIDEBAR-->
        ...
        <div class="page-container">
            <!-- HEADER DESKTOP-->
            <?php if(!isset($noNav)): ?>
                <?php echo $__env->make('layout.template.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
            <!-- END HEADER DESKTOP-->
...
<!-- end document-->
<?php /**PATH C:\xampp\htdocs\first-project\resources\views/layout/admin.blade.php ENDPATH**/ ?>